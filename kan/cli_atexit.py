...
def _auto_install_completion() -> None:
    ...
    try:
        ...
        # CR-4 (v0.0.4.8): paths import 极罕见 (e.g. test monkey-patch) · debug log
    ...
    try:
        ...
        # CR-4 (v0.0.4.8): file IO 失败 (e.g. read-only fs) · debug log
    ...
    try:
        ...
        # CR-4 (v0.0.4.8): typer/click 第三方 · broad catch + debug log
    ...
    try:
        ...
        # CR-4 (v0.0.4.8): console IO 罕见失败 · atexit 路径加 debug log 不能 crash 主流程
...
def _check_updates_atexit() -> None:
    ...
    try:
        ...
        # CR-4 (v0.0.4.8): 加 debug log 防完全无诊断
