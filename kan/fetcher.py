...
v0.0.5.0 起架构拆为两层:
- `kan.data_sources` 单点数据源 fetcher(eastmoney/baostock/sina/tencent + akshare race)
- `kan.fetcher`(本文件) cache + fallback 编排 + `fetch_kline` / `fetch_batch` 公开 API
